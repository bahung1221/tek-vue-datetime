  ...
  export default {
    ...
    methods: {
      ...
      noticeDeprecation () {
        ...
        if (useDeprecatedAPI) console.warn('[tek-vue-datetime]: You\'re using a deprecated API. Check the changelog (https://github.com/bahung1221/tek-vue-datetime/releases) for migration guide.')
      },
      /**
